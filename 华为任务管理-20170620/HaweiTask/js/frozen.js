...
!function($){
	...
	// 默认模板
	var _dialogTpl='<div class="mui-ht-dialog">'+
        '<div class="mui-ht-dialog-cnt">'+
            '<div class="mui-ht-dialog-bd">'+
                '<div>'+
                '<h4><%=title%></h4>'+
                '<div><%=content%></div></div>'+
            '</div>'+
            '<div class="mui-ht-dialog-ft mui-ht-btn-group">'+
...
!function($){
	...
	// 默认模板
	var _loadingTpl='<div class="mui-ht-loading-block show">'+
		    '<div class="mui-ht-loading-cnt">'+
		      '<i class="mui-ht-loading-bright"></i>'+
		      '<p><%=content%></p>'+
		   '</div>'+
		 '</div>';
...
function Scroll(el, options) {
	...
	if (this.options.role === 'slider') {
		...
		this.scroller = $('.mui-ht-slider-content')[0];
		...
		if (this.options.indicator) {
			var temp = '<ul class="mui-ht-slider-indicators">';
			...
			this.indicator = $('.mui-ht-slider-indicators')[0];
		}
	}
	...
	// ==================================
		...
		this.scroller = $('.mui-ht-tab-content')[0];
		this.nav = $('.mui-ht-tab-nav')[0];
...
Scroll.prototype = {
	...
	_end: function (e) {
		...
		// tab
		// ==========================
		if (this.options.role === 'tab' && $(event.target).closest('ul').hasClass('mui-ht-tab-nav')) {
...
!function($){
	...
	// 默认模板
	var _tipsTpl='<div class="mui-ht-poptips mui-ht-poptips-<%=type%>">'+
					'<div class="mui-ht-poptips-cnt">'+
    				'<i></i><%=content%>'+
					'</div>'+
				'</div>';
